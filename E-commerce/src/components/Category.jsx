      ...
      <div class="container py-5 mt-5">
        <div class="row text-center text-md-start">
          <div class="col-12 col-sm-6 col-md-3 mb-4">
            <div class="d-flex align-items-start gap-3 justify-content-center justify-content-md-start">
          ...
          <div class="col-12 col-sm-6 col-md-3 mb-4">
            <div class="d-flex align-items-start gap-3 justify-content-center justify-content-md-start">
              <i class="bi bi-tag fs-3 text-danger"></i>
              <div>
                <h6 class="fw-bold mb-1">Daily Offers</h6>
                <p class="mb-0 text-muted">
          ...
          <div class="col-12 col-sm-6 col-md-3 mb-4">
            <div class="d-flex align-items-start gap-3 justify-content-center justify-content-md-start">
              <i class="bi bi-shield-plus fs-3 text-danger"></i>
              <div>
                <h6 class="fw-bold mb-1">100% Secure Payment</h6>
                <p class="mb-0 text-muted">
